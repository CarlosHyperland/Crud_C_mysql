	 ...
	 //metodos
	   void crear(){
		   ...
		   if (cn.getConector()) {
			   ...
			   if (!q_estado) {
				   ...
				   cout << "zzzzzzzz Consulta Fallida zzzzzzzz" << endl;
			   }


		   }
		   else {
			   cout << "xxxxx Conexion Fallida xxxxx"<<endl;
		   }
		   cn.cerrar_conexion();
	   ...
	   void leer(){
		   ...
		   if (cn.getConector()) {
			   ...
			   string consulta = "select e.id_estudiante as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento,ts.sangre from estudiantes as e inner join tipos_sangre as ts on e.id_tipo_sangre = ts.id_tipos_sangre;";
			   const char* c = consulta.c_str();
			   q_estado = mysql_query(cn.getConector(),c);
			   if (!q_estado) {
			   ...
			   cout << "xxxxx Fallo La Conexion xxxxx" << endl;
		   }
		   cn.cerrar_conexion();
	   }
	   ...
	   void actualizar() {
		   ...
		   if (cn.getConector()) {
			   ...
			   q_estado = mysql_query(cn.getConector(), c);
			   if (!q_estado) {
				   cout << "Modificacion de Dato Exitoso......." << endl;
			   }
			   else {
				   cout << "zzzzzzzz Consulta Fallida zzzzzzzz" << endl;
			   }
	   ...
	   void borrar() {
		   ...
		   if (cn.getConector()) {
			   ...
			   q_estado = mysql_query(cn.getConector(), c);
			   if (!q_estado) {
				   cout << "Eliminacion de Dato Exitoso......." << endl;
			   }
			   else {
				   cout << "zzzzzzzz Consulta Fallida zzzzzzzz" << endl;
			   }
